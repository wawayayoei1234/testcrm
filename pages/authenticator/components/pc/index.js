...
function Index() {
  ...
  const otpAuthUrl = 'otpauth://totp/soft-token:thananchai%40tracthai.com?secret=LLLBGXBI5Q2LHKULWCGEMCI6CHBZGUAEVSRDNX5UVZK6RAH7XN4A&issuer=soft-token';
  ...
  return (
   <>
        ...
        <Box className="borderotp" >
          <Box sx={{mt:2,mb:2}}>
             <QRCode value={otpAuthUrl} size={150} level={"H"} />
          </Box>
        </Box>
        <Box pb={3} pt={2} >
