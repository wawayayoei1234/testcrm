  ...
  return (
      <Box sx={{background:`linear-gradient(${themedata[0].primary}, ${themedata[0].three})`,height:"100vh",width:'100%'}}>
        ...
        transform: 'translate(-50%, -50%)'}}> 
          ...
          <Box pb={3} sx={{color: `${themedata[0].four}`, fontSize: 13, fontFamily: 'Avenir', fontWeight: '0', 
        ...
        <Link href="/registration" >
          ...
          width: '300px', height: 'auto',textTransform:'capitalize', fontFamily: 'Avenir',color:`${themedata[0].three}` }}>Next
          </Button> 
          </Link>      
        </Box>
        </Box>
