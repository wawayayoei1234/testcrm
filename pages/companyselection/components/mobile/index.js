    ...
    return (
      <Box sx={{ background: "linear-gradient( #84BAA1, #FFFBE2 )", height: "100vh", width: '100%' }}>
        <Box p={3} sx={{
          ...
          <Box sx={{ color: '#171717', fontSize: 20, fontFamily: 'Avenir', fontWeight: '800', wordWrap: 'break-word' }}>Company Selection</Box>
          <Box pb={3} sx={{ color: '#7F8391', fontSize: 13, fontFamily: 'Avenir', fontWeight: '0', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
          ...
          <Box sx={{
            ...
            <Box sx={{ width: "100%", height: 'auto', background: 'white', borderRadius: 1, border: '1px #48846B solid', p: 1 }}>
            ...
            <Box marginTop={1} sx={{ width: "100%", height: 'auto', background: 'white', borderRadius: 1, border: '1px #48846B solid', p: 1 }}>
          ...
          <Box p={5}>
            <Button variant='contained' sx={{
              fontSize: '12px', padding: '6px 12px', backgroundColor: '#DAEBE3',
              width: '300px', height: 'auto', textTransform: 'capitalize', fontFamily: 'Avenir', color: '#fff'
            }}>Next</Button>
          </Box>
        </Box>
      </Box>
