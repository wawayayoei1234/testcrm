    ...
    return (
      <Box sx={{ background: `linear-gradient(${themedata[0].primary}, ${themedata[0].three})`, height: "100vh", width: '100%' }}>
        <Box p={3} sx={{
          ...
          <Box sx={{ color: `${themedata[0].ten}`, fontSize: 20, fontFamily: 'Avenir', fontWeight: '800', wordWrap: 'break-word' }}>Company Selection</Box>
          <Box pb={3} sx={{ color: `${themedata[0].four}`, fontSize: 13, fontFamily: 'Avenir', fontWeight: '0', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
          ...
          <Box sx={{
            ...
            <Box sx={{ width: "100%", height: 'auto', background: 'white', borderRadius: 1, border: `1px ${themedata[0].secondary} solid`, p: 1 }}>
              <span style={{ color: `${themedata[0].ten}`, fontFamily: 'Avenir', fontWeight: '800' }}>Yes! </span>
              <span style={{ color: `${themedata[0].ten}`, fontFamily: 'Avenir', fontWeight: '350', fontSize: '10px' }}>
            ...
            <Box marginTop={1} sx={{ width: "100%", height: 'auto', background: 'white', borderRadius: 1, border: `1px ${themedata[0].secondary} solid`, p: 1 }}>
              <span style={{ color: `${themedata[0].ten}`, fontFamily: 'Avenir', fontWeight: '900' }}>No! </span>
              <span style={{ color: `${themedata[0].ten}`, fontFamily: 'Avenir', fontWeight: '350', fontSize: '10px' }}>
          ...
          <Box p={5}>
            <Button variant='contained' sx={{
              ...
              width: '300px', height: 'auto', textTransform: 'capitalize', fontFamily: 'Avenir', color: `${themedata[0].three}`
            }}>Next</Button>
          </Box>
        </Box>
      </Box>
