...
export default function () {
  return (
    <Box >
        ...
        <Box sx={{display:'flex',justifyContent:'center',}}>
          <Box p={1}>
        <Box p={3} sx={{width: 430, height: 400,background: `${themedata[0].nine}`, borderRadius: 5}} >
        <Box style={{width: '100%', color: `${themedata[0].ten}`, fontSize: 14, fontFamily: 'Avenir', fontWeight: '400', wordWrap: 'break-word'}}>October 2023</Box>
        <Box style={{color: `${themedata[0].ten}`, fontSize: 24, fontFamily: 'Avenir', fontWeight: '350', wordWrap: 'break-word'}}>Calendar & Activity</Box>
        ...
        <Box style={{left: 50, top: 29, position: 'absolute', color: `${themedata[0].ten}`, fontSize: 20, fontFamily: 'Avenir', fontWeight: '350', wordWrap: 'break-word'}}>Activity 1</Box>
        <Box style={{width: 450, left: 50, top: 85, position: 'absolute', color: `${themedata[0].eight}`, fontSize: 12, fontFamily: 'Avenir', fontWeight: '300', wordWrap: 'break-word'}}>Lorem ipsum dolor sit amet consectetur. Quam id vehicula<br></br> dictum donec tincidunt.</Box>
        </Box>
        <br></br>
        <Box style={{width: '100%', height: '140px', position: 'relative', background: 'white', borderRadius: 20, overflow: 'hidden', border: `${themedata[0].seven}`}}>
        <Box style={{width: 12, height: 180, left: 0, top: 0, position: 'absolute', background: `${themedata[0].six}`}} />
        <Box style={{left: 50, top: 29, position: 'absolute', color: `${themedata[0].ten}`, fontSize: 20, fontFamily: 'Avenir', fontWeight: '350', wordWrap: 'break-word'}}>Activity 2</Box>
        <Box style={{width: 450, left: 50, top: 85, position: 'absolute', color: `${themedata[0].eight}`, fontSize: 12, fontFamily: 'Avenir', fontWeight: '300', wordWrap: 'break-word'}}>Lorem ipsum dolor sit amet consectetur. Quam id vehicula<br></br> dictum donec tincidunt.</Box>
