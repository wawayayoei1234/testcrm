...
function Index() {
  ...
  return (
   <>
        ...
        <Box sx={{ color: `${themedata[0].ten}`, fontSize: 20, fontFamily: frontdata[0].font, fontWeight: '800', wordWrap: 'break-word',}}>Email Verification</Box>
        <Box pb={3} sx={{color: `${themedata[0].four}`, fontSize: 15, fontFamily: frontdata[0].font, fontWeight: '0', textAlign: 'left'}}>We have sent code to your Email <strong>{state.decode_token.email}</strong></Box>
        <Box pb={3} >
