...
function Index() {
  ...
  return (
   <>
        ...
        <Box pb={3} sx={{color: `${themedata[0].four}`, fontSize: 15, fontFamily: frontdata[0].font, fontWeight: '0', textAlign: 'left'}}>{OTPText[0].description} <strong>{state.decode_token.email}</strong></Box>
        <Box pb={3} >
